...
export const DeviceIcon = ({ type, size = 28 }: DeviceIconProps) => {
  ...
  if (type === 'router') return (
    <svg width={size} height={size} viewBox="0 0 28 28" fill="none" role="img" aria-label={getLabel()}>
      <rect x="3" y="9" width="22" height="10" rx="2" stroke="#f2c434" strokeWidth="1.8" fill="none"/>
      <circle cx="8" cy="14" r="2" fill="#f2c434"/>
      <circle cx="14" cy="14" r="2" fill="#f2c434"/>
      <circle cx="20" cy="14" r="2" fill="#1ea86a"/>
  ...
  if (type === 'switch') return (
    <svg width={size} height={size} viewBox="0 0 28 28" fill="none" role="img" aria-label={getLabel()}>
      ...
      {[6,9,12,15,18,21].map((x,i) => (
        <rect key={i} x={x-1} y="12.5" width="2" height="5" rx=".8" fill={i<4?'#f2c434':'#7a95b0'}/>
      ))}
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 28 28" fill="none" role="img" aria-label={getLabel()}>
      ...
      <circle cx="11" cy="5" r="1.5" fill="#1ea86a"/>
      <circle cx="11" cy="14" r="1.5" fill="#1ea86a"/>
      <circle cx="11" cy="23" r="1.5" fill="#e8a012"/>
    </svg>
  );
};
